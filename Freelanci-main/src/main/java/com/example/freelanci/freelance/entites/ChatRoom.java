...
public class ChatRoom {
    ...
    private List<com.example.freelanci.freelance.entites.Message> messages;
    ...
    public List<com.example.freelanci.freelance.entites.Message> getMessages() {
        return messages;
    }

    public void setMessages(List<com.example.freelanci.freelance.entites.Message> messages) {
