...
public class User {
    ...
    private List<com.example.freelanci.freelance.entites.Message> sentMessages;
    @OneToMany(mappedBy = "receiver")
    @JsonManagedReference("receivedMessages")
    private List<com.example.freelanci.freelance.entites.Message> receivedMessages;
    // Getters and Setters
