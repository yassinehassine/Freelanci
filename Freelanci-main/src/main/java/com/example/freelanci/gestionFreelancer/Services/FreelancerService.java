...
import com.example.freelanci.gestionFreelancer.Services.ProposalService;
...
public class FreelancerService implements IFreelancerService {
    ...
    public Freelancer getFreelancerById(long freelancerId) {
        return freelancerRepository.findById(freelancerId).orElse(null);  // Return null if freelancer doesn't exist
    }
    }
